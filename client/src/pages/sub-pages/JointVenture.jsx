...
const JointVenture3 = () => {
  ...
  const handleFinanceFormSubmit = (data) => {
    ...
    fetch('http://localhost:5000/apiTender/services/jointventure', {
      method: 'POST',
      headers: {
        auth: token,
      },
...
const JointVenture = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Handle form submission for pages 1 and 2
    nextPage(currentPage + 1);
  };

  return (
    <>
      <JointVenture1 currentpage={currentPage} nextPage={nextPage} />
      <JointVenture2
