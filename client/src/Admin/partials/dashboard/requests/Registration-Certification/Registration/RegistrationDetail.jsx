                        ...
                        <div className="flex justify-center flex-shrink">
                            <div className="bg-white rounded-lg  p-20 shadow-2xl w-3/4">
                                ...
                                <div className="w-full">
                                    <label className="block mb-2 text-xl font-medium ">Company</label>
                                    <input
                                        type="text"
                                ...
                                <div className="grid grid-cols-2 mb-4 mt-4 gap-11">
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Mobile</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid grid-cols-2 gap-11">
                                    ...
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Work Mobile</label>
                                        <input
                                            type="text"
                                            className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200"
                                ...
                                <div className="grid grid-cols-2 gap-11">
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Company Profile</label>
                                        <input
                                            type="text"
                                            className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200"
                                    ...
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Other Details</label>
                                        <input
                                            type="text"
                                            className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200"
                                ...
                                <div className="grid grid-cols-2 gap-11">
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Company Post</label>
                                        <input
                                            type="text"
                                            className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200"
                                            ...
                                            readOnly={!isEditing}
                                            onChange={(e) =>
                                                setFormData({ ...formData, companypost: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">License</label>
                                        <input
                                            type="text"
                                            className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200"
                                ...
                                <div className="grid grid-cols-2 gap-11">
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Contact Person Name</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid grid-cols-2 gap-11">
                                    ...
                                    <div>
                                        <label className="block mb-2 text-xl font-medium">Registration URL</label>
                                        <input
                                            type="text"
                                            className="border text-lg border-gray-300 rounded-md p-2 py-4 w-full bg-gray-200"
